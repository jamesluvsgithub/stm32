...
Each project builds on the last, and they are numbered in order. Every project will contain:
- The source code that I wrote. It will be located in /Core/Src/
- The necessary files to build and run the project in a new, blank STM32CubeIDE environment, such as the .ioc, drivers, etc
